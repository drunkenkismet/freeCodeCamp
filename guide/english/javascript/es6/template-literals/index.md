...
## Introduction:
When we want to use variable to make a string, it becomes very painful having to use `+` sign to concatenate and keep track of quotes.

With ES6, we can now construct strings using backticks and variable placeholders, which are indicated with a dollar sign and curly braces, like ${expression } .
```javascript
const name='John';
const city='London';
